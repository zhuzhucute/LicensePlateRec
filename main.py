...
from PySide2.QtWidgets import QDialog, QMainWindow, QApplication
...
class dialogUi(QDialog):
    def __init__(self, parent=None):
        ...
        self.d = Ui_Dialog()
        self.d.setupUi(self)
        self.setWindowFlags(Qt.FramelessWindowHint) # REMOVING WINDOWS TOP BAR AND MAKING IT FRAMELESS (AS WE HAVE AMDE A CUSTOME FRAME IN THE WINDOW ITSELF)
        self.setAttribute(Qt.WA_TranslucentBackground) # MAKING THE WINDOW TRANSPARENT SO THAT TO GET A TRUE FLAT UI
...
class MainWindow(QMainWindow):
    def __init__(self):
        ...
        applicationName = "License Plate Recognition"
        ...
        #NOW SINCE OUR DEMO APPLICATION HAS ONLY 4 MENU BUTTONS: Home, WHEN USER PRESSES IT THE FOLLOWING CODE             ---------(C8)
